...
document.addEventListener('DOMContentLoaded', function() {
                ...
                <div class="search-results-header mb-8 bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <button id="exportCsvBtn" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200 flex items-center gap-2">
    ...
    function exportSearchResults() {
        ...
        formData.append('action', 'grant_insight_export_results');
        formData.append('nonce', gi_ajax.nonce);
        
        // 検索フォームの値を取得
        const searchForm = document.getElementById('advanced-search-form');
        if (searchForm) {
            const formElements = new FormData(searchForm);
